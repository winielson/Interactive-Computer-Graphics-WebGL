...
function studentdata() {
    ...
    const firstname = 'Winielson';
    const studentnum = '31393903';
...
function createTriangleGasketGeometry(recursions, lambda) {
    ...
    function divideTriangle(a, b, c, ca, cb, cc, count) {
        ...
        if (count == 0) {
            ...
            // three new triangles
            divideTriangle(a, ab, ac, ca, cb, cc, count - 1);
            divideTriangle(c, ac, bc, ca, cb, cc, count - 1);
            divideTriangle(b, bc, ab, ca, cb, cc, count - 1);
        }
    }
}
...
function main() {
    ...
    gl.bufferData(
        ...
        new Float32Array(geometry),     // We pass it as a 32 bit float. 
